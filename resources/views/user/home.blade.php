              ...
              <div id="sequence">
                <ul>
                  ...
                  <li>
                    ...
                    <img class="slider_img animate-in" src="{{asset('serenity/img/slides/sequence/img-1.png')}}" alt="">
                  </li>
                  <!-- Layer 2 -->
                  <li>
                    <div class="info">
                    ...
                    <img class="slider_img" src="{{asset('serenity/img/slides/sequence/img-2.png')}}" alt="">
                  </li>
                  <!-- Layer 3 -->
                  <li>
                    <div class="info">
                    ...
                    <img class="slider_img" src="{{asset('serenity/img/slides/sequence/img-3.png')}}" alt="">
                  </li>
                </ul>
              </div>
            </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="home-posts">
          ...
          <img src="{{asset('serenity/img/dummies/blog1.jpg')}}" alt="">
          </a>
            </div>
          ...
          <div class="span3">
            <div class="post-image">
              <a href="#"><img src="{{asset('serenity/img/dummies/blog2.jpg')}}" alt=""></a>
            </div>
            <div class="entry-meta">
              <a href="#"><i class="icon-square icon-48 icon-pencil left"></i></a>
            ...
            <div class="row">
              <div class="span12">
                ...
                <div class="btn-toolbar cta">
                  <a class="btn btn-large btn-color" href="{{route ('viewpost')}}"><i class="icon-rounded icon-plus"></i> Lihat Semua Post </a>
                </div>
              </div>
            </div>
          </div>
