          ...
          <div class="span12">
            <!-- <h4>Write your story and share on<strong> post</strong></h4> -->
              <div class="cta floatleft">
                <a class="btn btn-medium btn-theme btn-rounded" href="{{route ('index')}}"><i class="icon-undo"></i> Back </a>
              </div>
            <form method="post" role="form" class="contactForm" action="{{url('ultah-tambah')}}" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="span12 margintop10 form-group">
                  	...
                  	<input type="text" class="form-control" id="name" placeholder="Deskripsi" data-rule="minlen:4" data-msg="Please enter title" required="" name="deskripsi"/>
                  	<div class="validation"></div>
                </div>
                <p class="text-center">
